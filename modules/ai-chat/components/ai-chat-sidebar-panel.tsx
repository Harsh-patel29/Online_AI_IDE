                ...
                <div className="flex items-center gap-2">
                    ...
                    <select
                      ...
                      className={`${
                        theme === "dark"
                          ? "bg-zinc-900 / 60"
                          : "bg-white text-black"
                      } border border-zinc-800 rounded px-2 py-1  focus:outline-none`}
                    >
                      <option value="gemini-2.5-flash" className="text-black">
                        gemini-2.5-flash
                      </option>
                    </select>
                  </div>
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className={`pl-7 h-8 w-40 bg-zinc-800/50 ${
                        theme === "dark" ? "border-zinc-700/50" : "bg-white"
                      }`}
                    />
                  </div>
                      ...
                      <button
                        ...
                        className={`px-3 py-2 ${
                          theme === "dark"
                            ...
                            : "bg-white/50 text-black hover:bg-gray-200"
                    ...
                    <div
                      className={cn(
                        ...
                        msg.role === "user"
                          ...
                          : ` ${
                              theme === "light"
                                ? "bg-gray-200 text-black border-white-800/50"
                                : "bg-zinc-900/80   text-zinc-100 border-zinc-800/50"
                            } backdrop-blur-sm p-5 rounded-bl-md border `
                      )}
                    >
                      {msg.role === "assistant" && (
              ...
              <div className="flex-1 relative">
                <Textarea
                  ...
                  className={`min-h-[44px] max-h-32 ${
                    theme === "dark"
                      ? "bg-zinc-800/50 border-zinc-700/50 text-zinc-100 placeholder-zinc-500 focus:ring-blue-500/20 "
                      : ""
                  } focus:border-blue-500 resize-none pr-20`}
                  rows={1}
                />
                <div className="absolute right-3 bottom-3 flex items-center gap-2">
                  <kbd
                    className={`hidden sm:inline-block px-1.5 py-0.5 text-xs ${
                      theme === "dark"
